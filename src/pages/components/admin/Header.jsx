              ...
              <details class="group [&_summary::-webkit-details-marker]:hidden">
                ...
                <nav aria-label="Teams Nav" class="mt-2 flex flex-col px-4">
                  ...
                  >
                    ...
                    <span class="text-sm font-medium"> Pending Tickets </span>
                  </a>
                  <a
              ...
              <details class="group [&_summary::-webkit-details-marker]:hidden">
                <summary class="flex cursor-pointer items-center justify-between rounded-lg px-4 py-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700">
                  <div class="flex items-center gap-2">
                    ...
                    <span class="text-sm font-medium"> Knowledgebase </span>
                  </div>
                ...
                <nav aria-label="Account Nav" class="mt-2 flex flex-col px-4">
                  ...
                  >
                    ...
                    <span class="text-sm font-medium"> All Knowledgebase </span>
                  </a>

                  <a
                    href="/admin/pendingknowledgebase"
                    class="flex items-center gap-2 rounded-lg px-4 py-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span class="text-sm font-medium"> Pending Knowledgebase </span>
                  </a>
                </nav>
              </details>
